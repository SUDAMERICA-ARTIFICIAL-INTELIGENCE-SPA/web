...
const words = [
    ...
    { text: "a" },
    { text: "automatizar" },
    { text: "hoy", className: "text-cyan-400 dark:text-cyan-400" },
    { text: "today." },
]

export default function CTASection() {
    return (
        <section className="flex flex-col items-center jhoytify-center py-24 px-6 bg-black text-white">
            <TypewriterEffectSmooth words={words} />
            <p className="text-gray-400 mt-4 text-lg max-w-xl text-center">
                Únete a empresas que ya automatizan y crecen con menos esfuerzo.
            </p>
