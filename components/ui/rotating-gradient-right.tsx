...
export default function RotatingGradientRight() {
  return (
    <section className="min-h-screen w-full bg-white dark:bg-black text-black dark:text-white py-16">
      <div className="max-w-7xl mx-auto px-8 md:px-16 grid items-center gap-12 md:grid-cols-2">
        {/* LEFT: Text */}
